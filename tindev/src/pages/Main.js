...
export default function Main({ navigation }) {
    ...
    async function handleLike() {
        // através da desestruturação, pega o primeiro elemento do array e 
        // coloca os restantes em um novo array
        // const [{ _id }, ...rest] = users; -> pegaria apenas o id do primeiro elemento 
...
const styles = StyleSheet.create({
    ...
    matchImage: {
        height: 60,
        // redimensiona o tamanho da imagem para que ela caiba no seu container
        resizeMode: 'contain',
    },
    matchAvatar: {
        width: 160,
